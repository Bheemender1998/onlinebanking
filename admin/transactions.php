                                                ...
                                                <div class="table-responsive">
                                                    <table class="table v-middle table-striped table-bordered table-hover">
                                                        ...
                                                        <tbody>
                                                           ...
                                                           $cursor = $collection->find([]); // Sort by id in descending order
                                                           $increment=1;
                                                           
                                                               foreach ($cursor as $row) {
                                                           if($row['Date']){
                                                                $utcDateTime = $row['Date']; // Assuming date is stored as MongoDB\BSON\UTCDateTime

                                                                // Check if $utcDateTime is not null before calling toDateTime() method
                                                                if ($utcDateTime !== null) {
                                                                    // Get the Unix timestamp from the UTCDateTime object
                                                                    ...
                                                                    $formattedDate = ''; // Set default value if $utcDateTime is null
                                                                }
                                                            }
                                                            else{
                                                                $formattedDate = ''; 
